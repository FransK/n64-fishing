...
Vector3 Cylinder::MinkowskiSum(const ColliderTypeData &data, const Vector3 &direction)
{
    Vector3 output;
...
Box3D Cylinder::BoundingBox(const ColliderTypeData &data, const Vector2 &rotation)
{
    Box3D box;
