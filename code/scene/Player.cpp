...
{
    mPlayerState->update(deltaTime, *this, *mScene);
    switch (mPlayerState->getState())
    {
    ...
    case PlayerStateEnum::STATE_FISHING:
        ...
        if (inputState.fish)
        {
            ...
            if (mPlayerState->getStateTimer() <= CATCH_TIMER)
            {
                // Successful catch
                mPlayerState->setActionSuccess(true);
            }
            mPlayerState->changeState(PlayerStateEnum::STATE_IDLE, *this, *mScene);
        }
        break;
    ...
    case PlayerStateEnum::STATE_IDLE:
        ...
        {
            // Start attack
            mPlayerState->changeState(PlayerStateEnum::STATE_ATTACKING, *this, *mScene);
            break;
        }
        ...
        {
            // Start fishing
            mPlayerState->changeState(PlayerStateEnum::STATE_CASTING, *this, *mScene);
            break;
        }
        ...
        if (abs(inputState.move.x) > MIN_MOVE_INPUT || abs(inputState.move.y) > MIN_MOVE_INPUT)
        {
            ...
            // Start walking
            mPlayerState->changeState(PlayerStateEnum::STATE_WALKING, *this, *mScene);
